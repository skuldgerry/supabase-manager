...
const HCAPTCHA_SUBDOMAINS_URL = process.env.NEXT_PUBLIC_HCAPTCHA_SITE_KEY ? 'https://*.hcaptcha.com' : ''
const HCAPTCHA_ASSET_URL = process.env.NEXT_PUBLIC_HCAPTCHA_SITE_KEY ? 'https://newassets.hcaptcha.com' : ''
const HCAPTCHA_JS_URL = process.env.NEXT_PUBLIC_HCAPTCHA_SITE_KEY ? 'https://js.hcaptcha.com' : ''
...
const STRIPE_SUBDOMAINS_URL = process.env.NEXT_PUBLIC_STRIPE_PUBLIC_KEY ? 'https://*.stripe.com' : ''
const STRIPE_JS_URL = process.env.NEXT_PUBLIC_STRIPE_PUBLIC_KEY ? 'https://js.stripe.com' : ''
const STRIPE_NETWORK_URL = process.env.NEXT_PUBLIC_STRIPE_PUBLIC_KEY ? 'https://*.stripe.network' : ''
