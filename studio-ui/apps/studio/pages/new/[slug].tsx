...
import { SelfHostedProjectCreation } from '@/components/interfaces/ProjectCreation/SelfHostedProjectCreation'
...
const Wizard: NextPageWithLayout = () => {
  ...
  // Self-hosted: skip the platform-specific wizard and show a simpler connection form
  if (!IS_PLATFORM) {
    return (
      <>
        <Head>
