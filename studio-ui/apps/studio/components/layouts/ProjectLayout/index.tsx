...
export const ProjectLayout = forwardRef<HTMLDivElement, PropsWithChildren<ProjectLayoutProps>>(
  (
    ...
    // In self-hosted mode, INACTIVE means the Docker stack failed to launch —
    // not a platform pause. Never show the "paused" gate in self-hosted.
    const isPaused = IS_PLATFORM && selectedProject?.status === PROJECT_STATUS.INACTIVE
