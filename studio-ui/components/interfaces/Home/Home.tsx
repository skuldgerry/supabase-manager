...
import { ProjectProvisioningState } from '@/components/interfaces/SelfHostedProjects/ProjectProvisioningState'
...
export const Home = () => {
  ...
  if (!IS_PLATFORM && project?.status === PROJECT_STATUS.COMING_UP && ref && ref !== 'default') {
    return <ProjectProvisioningState projectRef={ref} />
  }
