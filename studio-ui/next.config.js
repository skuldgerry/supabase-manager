...
const nextConfig = {
  ...
  sassOptions: {
    // packages/ui lives at the monorepo root locally, and at /app/ in Docker
    // (where it's copied alongside the studio files). Both paths are searched.
    includePaths: [
      path.resolve(__dirname),           // Docker: /app
      path.resolve(__dirname, '../..'),  // Local monorepo: supabase-master/
    ],
  },
  turbopack: {
    rules: {
